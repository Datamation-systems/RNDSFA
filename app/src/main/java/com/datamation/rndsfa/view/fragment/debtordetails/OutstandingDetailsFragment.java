...
//        }
    ...
    private static class ViewHolder {
        LinearLayout layout;
        com.datamation.rndsfa.viewmodel.utils.CustomFont invoiceId;
        com.datamation.rndsfa.viewmodel.utils.CustomFont invoiceDate;
        com.datamation.rndsfa.viewmodel.utils.CustomFont invoiceAmt;
        com.datamation.rndsfa.viewmodel.utils.CustomFont invoiceBalance;
        com.datamation.rndsfa.viewmodel.utils.CustomFont invoiceDays;
    }
    ...
    private class OutletOutstandingAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.invoiceId = (com.datamation.rndsfa.viewmodel.utils.CustomFont) convertView.findViewById(R.id.row_refno);
                viewHolder.invoiceDate = (com.datamation.rndsfa.viewmodel.utils.CustomFont) convertView.findViewById(R.id.row_txndate);
                viewHolder.invoiceAmt = (com.datamation.rndsfa.viewmodel.utils.CustomFont) convertView.findViewById(R.id.row_dueAmt);
                viewHolder.invoiceBalance = (com.datamation.rndsfa.viewmodel.utils.CustomFont) convertView.findViewById(R.id.row_Amt);
                viewHolder.invoiceDays = (com.datamation.rndsfa.viewmodel.utils.CustomFont) convertView.findViewById(R.id.days);
