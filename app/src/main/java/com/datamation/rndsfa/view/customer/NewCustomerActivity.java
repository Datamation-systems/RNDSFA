package com.datamation.rndsfa.view.customer;
...
import com.datamation.rndsfa.viewmodel.adapter.Customer_Adapter;
import com.datamation.rndsfa.viewmodel.adapter.DistrictAdapter;
import com.datamation.rndsfa.viewmodel.adapter.RouteAdapter;
import com.datamation.rndsfa.viewmodel.adapter.TownAdapter;
import com.datamation.rndsfa.viewmodel.controller.CustomerController;
import com.datamation.rndsfa.viewmodel.controller.DistrictController;
...
import com.datamation.rndsfa.viewmodel.helpers.Validation;
import com.datamation.rndsfa.model.Customer;
import com.datamation.rndsfa.model.District;
...
import com.datamation.rndsfa.viewmodel.settings.GPSTracker;
...
//            Bitmap bmp = (Bitmap) data.getExtras().get("data");
    ...
    private void uploadFile(String imgName) {
        ...
        if (filePath != null) {
            ...
            try {
                ...
                StorageReference mStorageReference = storage.getReferenceFromUrl("gs://swdnew-d8d42.appspot.com/").child("images/" + imagepathName);
    ...
    public void customerListDialogBox() {
        ...
        Detlist.clearTextFilter();
            ...
            newCustomerArrayList = newCustomerDS.getAllCusDetailsForEdit("");
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                try {
                        newCustomerArrayList = newCustomerDS.getAllCusDetailsForEdit(newText);
